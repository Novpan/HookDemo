...
public class WakeBinderProxyHookHandler implements InvocationHandler {

    private static final String TAG = "hook/WakeBinderHookHelper";
    ...
    public WakeBinderProxyHookHandler(IBinder base) {
        this.base = base;
        try {
            this.stub = Class.forName("android.os.IPowerManager$Stub");
            this.iinterface = Class.forName("android.os.IPowerManager");
    ...
    public Object invoke(Object proxy, Method method, Object[] objects) throws Throwable {
        if ("queryLocalInterface".equals(method.getName())) {
            ...
            return Proxy.newProxyInstance(proxy.getClass().getClassLoader(),
                    ...
                    new WakeBinderHookHandler(base, stub));
        }
