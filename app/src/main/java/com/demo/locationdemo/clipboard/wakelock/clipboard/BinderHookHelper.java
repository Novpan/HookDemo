package com.demo.locationdemo.clipboard.wakelock.clipboard;
...
public class BinderHookHelper {
    ...
    public static void hookClipboardService() throws Exception {
        ...
        // 一般来说这是一个Binder代理对象
        IBinder rawBinder = (IBinder) getService.invoke(null, Context.POWER_SERVICE);
        ...
        cache.put(Context.POWER_SERVICE, hookedBinder);
    }
